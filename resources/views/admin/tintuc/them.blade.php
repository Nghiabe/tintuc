            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/tintuc/them" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="article_desc" id="demo" class="form-control ckeditor" rows="3">{{ old('article_desc') }}</textarea>
                    </div>

                    <div class="form-group">
                        <p><label>Nội Dung Bài Viết</label></p>
                        <textarea name="article_content" id="demo" class="form-control ckeditor" rows="3">{{ old('article_content') }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
    <label for="shopee_link">Link Shopee</label>
    <input type="text" class="form-control" name="shopee_link" value="{{ old('shopee_link', $tintuc->shopee_link ?? '') }}">
</div>
